...
// â”€â”€â”€ Reusable Section Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Toggle Button Group â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Main Configurator â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        return (
          <>
            <div className="flex flex-col xl:flex-row gap-6 items-start max-w-[1440px] mx-auto pb-24">
              ...
              {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
                            RIGHT COLUMN â€” Configuration Controls
                        â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
                  ...
                  <>
                    ...
                    <SectionCard title="Location">
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          type="text"
                          value={(config as FixedConfig).location || ""}
                          onChange={(e) =>
                            updateConfig({ location: e.target.value } as any)
                          }
                      ...
                      <div className="flex flex-wrap gap-3 items-start">
                        {[
                          ...
                          <button
                            ...
                            className={`flex flex-col items-center p-3 border-2 rounded-xl w-28 transition-all ${(config as FixedConfig).outsideColor ===
                              color.value &&
                              !(config as FixedConfig).outsideRAL
                              ? "bg-sky-50 border-sky-400"
                              : "bg-white border-slate-200 hover:border-slate-300"
                              }`}
                          >
                        ...
                        {/* RAL Colour Input */}
                        <div
                          className={`flex flex-col items-center p-3 border-2 rounded-xl w-28 transition-all ${(config as FixedConfig).outsideRAL
                            ? "bg-sky-50 border-sky-400"
                            : "bg-white border-slate-200"
                            }`}
                        >
                          ...
                          <input
                            type="text"
                            value={(config as FixedConfig).outsideRAL || "0000"}
                            onChange={(e) =>
                              updateConfig({
                                outsideRAL: e.target.value,
                                outsideColor: `RAL ${e.target.value}`,
                          ...
                          <button
                            onClick={() => {
                              const ral =
                                (config as FixedConfig).outsideRAL || "0000";
                              updateConfig({
                                outsideRAL: ral,
                                outsideColor: `RAL ${ral}`,
                              } as any);
                      ...
                      <div className="flex flex-wrap gap-3 items-start">
                        {[
                          ...
                          <button
                            ...
                            className={`flex flex-col items-center p-3 border-2 rounded-xl w-28 transition-all ${(config as FixedConfig).insideColor ===
                              color.value &&
                              !(config as FixedConfig).insideRAL
                              ? "bg-sky-50 border-sky-400"
                              : "bg-white border-slate-200 hover:border-slate-300"
                              }`}
                          >
                        ...
                        {/* RAL Colour Input */}
                        <div
                          className={`flex flex-col items-center p-3 border-2 rounded-xl w-28 transition-all ${(config as FixedConfig).insideRAL
                            ? "bg-sky-50 border-sky-400"
                            : "bg-white border-slate-200"
                            }`}
                        >
                          ...
                          <input
                            type="text"
                            value={(config as FixedConfig).insideRAL || "0000"}
                            onChange={(e) =>
                              updateConfig({
                                insideRAL: e.target.value,
                                insideColor: `RAL ${e.target.value}`,
                          ...
                          <button
                            onClick={() => {
                              const ral =
                                (config as FixedConfig).insideRAL || "0000";
                              updateConfig({
                                insideRAL: ral,
                                insideColor: `RAL ${ral}`,
                              } as any);
                      ...
                      <div className="flex flex-wrap justify-center gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`flex flex-col items-center justify-center p-3 border-2 rounded-xl w-24 h-24 transition-all ${(config as FixedConfig).cill === opt.value
                              ? "bg-sky-50 border-sky-400"
                              : "bg-white border-slate-200 hover:border-slate-300"
                              }`}
                          >
                        ...
                        {(["Left", "Top", "Right"] as const).map((side) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <select
                                value={
                                  (config as FixedConfig).addons?.[sideKey] ||
                                  "None"
                                }
                                onChange={(e) => {
                                  const val =
                                    e.target.value === "None"
                                      ? null
                                      : e.target.value;
                                  const currentAddons = (config as FixedConfig)
                                    .addons || {
                                    left: null,
                                    right: null,
                                    top: null,
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              onClick={() => {
                                const current =
                                  (config as FixedConfig).transomBars || 0;
                                if (current > 0)
                                  updateConfig({
                                    transomBars: current - 1,
                                  } as any);
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              onClick={() => {
                                const current =
                                  (config as FixedConfig).astragalBars || 0;
                                if (current > 0)
                                  updateConfig({
                                    astragalBars: current - 1,
                                  } as any);
                    ...
                    <SectionCard title="Glass Type">
                      <div className="space-y-4">
                        ...
                        <div className="pb-4 flex flex-col gap-3">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                (config as FixedConfig).pas24 || false
                              }
                              onChange={(e) =>
                                updateConfig({
                                  pas24: e.target.checked,
                          ...
                          <div className="flex flex-col gap-2">
                            <label className="flex items-center gap-2 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={
                                  (config as FixedConfig).glassThickness !==
                                  undefined
                                }
                                onChange={(e) => {
                                  if (e.target.checked) {
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            {[
                              ...
                              <button
                                ...
                                className={`py-2 px-3 text-sm rounded-lg border transition-all ${(config as FixedConfig).glassType ===
                                  opt.value
                                  ? "bg-sky-50 border-sky-400 text-sky-700 font-medium"
                                  : "bg-white border-slate-200 text-slate-600 hover:border-slate-300"
                                  }`}
                        ...
                        {/* Glass Options for Toughened */}
                        {(config as FixedConfig).glassType === "toughened" && (
                          <div className="flex flex-col gap-2">
                            <span className="text-sm text-slate-600 font-medium">
                              Glass
                            </span>
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                              {[
                                ...
                                <button
                                  ...
                                  className={`p-3 text-sm flex items-center justify-center text-center border rounded-lg transition-all h-20 ${(config as FixedConfig).glassPattern === opt
                                    ? "bg-sky-50 border-sky-400 text-sky-700 font-medium"
                                    : "bg-white border-slate-200 text-slate-600 hover:border-slate-300"
                                    }`}
                                >
                        ...
                        {/* Obscure Pattern Options */}
                        {(config as FixedConfig).glassType ===
                          "toughened_obscure" && (
                            <div className="flex flex-col gap-2">
                              <span className="text-sm text-slate-600">
                                Obscure Pattern
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                {[
                                  ...
                                  <button
                                    ...
                                    className={`p-2 text-xs border rounded-lg transition-all ${(config as FixedConfig).glassPattern === opt
                                      ? "bg-sky-50 border-sky-400 text-sky-700 font-medium"
                                      : "bg-white border-slate-200 text-slate-600 hover:border-slate-300"
                                      }`}
                                  >
                  ...
                  <>
                        ...
                        <div className="flex flex-wrap justify-center gap-2">
                          {[2, 3, 4, 5, 6].map((n) => (
                            <button
                              key={n}
                              onClick={() => {
                                const bayConfig = config as BayConfig;
                                const newLengths = Array(n)
                                  .fill(0)
                                  .map((_, i) =>
                                    i < (bayConfig.lengths?.length || 0)
                                      ? bayConfig.lengths[i]
                                      : 0
                                  );
                    ...
                    <SectionCard title="Lengths">
                      <div className="grid grid-cols-4 gap-4">
                        {Array.from({
                          length: (config as BayConfig).numberOfPanes,
                        }).map((_, i) => (
                          <div
                            key={`len-${i}`}
                          ...
                          >
                            ...
                            <input
                              type="number"
                              value={
                                (config as BayConfig).lengths?.[i] || ""
                              }
                              onChange={(e) => {
                                const newLengths = [
                                  ...((config as BayConfig).lengths || []),
                                ];
                                newLengths[i] =
                                  parseInt(e.target.value) || 0;
                                updateConfig({
                    ...
                    <SectionCard title="Angles">
                      <div className="grid grid-cols-4 gap-4">
                        {Array.from({
                          length:
                            (config as BayConfig).numberOfPanes - 1,
                        }).map((_, i) => (
                          <div
                            key={`ang-${i}`}
                            className="flex flex-col items-center gap-1.5"
                          >
                            ...
                            <input
                              type="number"
                              value={
                                (config as BayConfig).angles?.[i] || ""
                              }
                              onChange={(e) => {
                                const newAngles = [
                                  ...((config as BayConfig).angles || []),
                                ];
                                newAngles[i] =
                                  parseInt(e.target.value) || 0;
                                updateConfig({
                    ...
                    <SectionCard title="Outside Frame Colour">
                      <div className="flex flex-wrap gap-3 items-start">
                        ...
                        >
                          ...
                          <input
                            type="text"
                            value={(config as BayConfig).outsideRAL || "0000"}
                            onChange={(e) =>
                              updateConfig({
                                outsideRAL: e.target.value,
                                outsideColor: `RAL ${e.target.value}`,
                          ...
                          <button
                            onClick={() => {
                              const ral =
                                (config as BayConfig).outsideRAL || "0000";
                              updateConfig({
                                outsideRAL: ral,
                                outsideColor: `RAL ${ral}`,
                              } as any);
                    ...
                    <SectionCard title="Inside Frame Colour">
                      <div className="flex flex-wrap gap-3 items-start">
                        ...
                        >
                          ...
                          <input
                            type="text"
                            value={(config as BayConfig).insideRAL || "0000"}
                            onChange={(e) =>
                              updateConfig({
                                insideRAL: e.target.value,
                                insideColor: `RAL ${e.target.value}`,
                          ...
                          <button
                            onClick={() => {
                              const ral =
                                (config as BayConfig).insideRAL || "0000";
                              updateConfig({
                                insideRAL: ral,
                                insideColor: `RAL ${ral}`,
                              } as any);
                    ...
                    <SectionCard title="Glass Type">
                      <div className="space-y-4">
                        <div className="pb-4 flex flex-col gap-3">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                (config as BayConfig).pas24 || false
                              }
                              onChange={(e) =>
                                updateConfig({
                                  pas24: e.target.checked,
                          ...
                          <div className="flex flex-col gap-2">
                            <label className="flex items-center gap-2 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={
                                  (config as BayConfig).glassThickness !==
                                  undefined
                                }
                                onChange={(e) => {
                                  if (e.target.checked) {
                        ...
                        {(config as BayConfig).glassType === "toughened" && (
                          <div className="flex flex-col gap-2">
                            <span className="text-sm text-slate-600 font-medium">
                              Glass
                            </span>
                  ...
                  <>
                    ...
                    <SectionCard title="Glass Type">
                      <div className="space-y-4">
                        ...
                        {/* Blinds â€” shown when Toughened is selected */}
                        {(config as any).glassType === "toughened" && (
                          <div className="flex flex-col gap-3 pt-2">
                            <span className="text-sm text-slate-600 font-medium">
                              Blinds
                            ...
                            {/* Blinds Colour â€” shown when Mechanical Blinds selected */}
                            {(config as any).blinds === "mechanical" && (
                              <div className="flex flex-col gap-2 mt-2">
                                <span className="text-sm text-slate-600 font-medium">
                                  Blinds Colour
