    ...
    const renderContent = () => {
        switch (step) {
            case 2:
                ...
                const priceBreakdown = config.type === ProductType.Bifold
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                                    ...
                                    <div className="px-4 py-3 border-t border-slate-100 flex items-center justify-between bg-white">
                                        <div className="flex items-center gap-2 text-xs text-slate-500">
                                            ...
                                            <span className="font-medium">{view === 'outside' ? 'Outside' : 'Inside'} View</span>
                                        </div>
                                        <button
                            ...
                            <div className="w-full xl:flex-1 min-w-0 space-y-4">
                                ...
                                <SectionCard title="Dimensions">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-xs font-medium text-slate-500 mb-1.5">Overall Width</label>
                                            <div className="relative">
                                                ...
                                                />
                                                <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-medium text-slate-400 bg-slate-50 px-1.5 py-0.5 rounded">mm</span>
                                            </div>
                                        </div>
                                        <div>
                                            <label className="block text-xs font-medium text-slate-500 mb-1.5">Overall Height</label>
                                            <div className="relative">
                                                <input
                                                    type="number"
                                                    value={config.height}
                                ...
                                {config.type === ProductType.FrenchDoor && (
                                    <>
                                        ...
                                        <SectionCard title="Master Handle">
                                            <div className="flex justify-center">
                                                <ToggleGroup
                                                    ...
                                                    onChange={(v) => updateConfig({ masterHandle: v } as any)}
                                                />
                                            </div>
                                        </SectionCard>
                                        ...
                                        <SectionCard title="Opening Direction">
                                            <div className="flex justify-center">
                                                <ToggleGroup
                                                    ...
                                                    onChange={(v) => updateConfig({ openingDirection: v } as any)}
                                                />
                                            </div>
                                        </SectionCard>
                                        ...
                                        <SectionCard title="Frame Colour">
                                            <ColourSection config={config as any} onChange={updateConfig as any} />
                                        </SectionCard>

                                        {/* Cills */}
                                        <SectionCard title="Cill">
                                            <CillSection config={config as any} onChange={updateConfig as any} />
                                        </SectionCard>
                                        ...
                                        <SectionCard title="Threshold">
                                            <div className="flex justify-center gap-4">
                                                <button
                                                    onClick={() => updateConfig({ threshold: 'standard' } as any)}
                                                ...
                                                >
                                                    ...
                                                    <span className="text-xs font-semibold text-slate-700">Standard 55mm</span>
                                                </button>
                                                <button
                                                    onClick={() => updateConfig({ threshold: 'low' } as any)}
                                                ...
                                                >
                                                    ...
                                                    <span className="text-xs font-semibold text-slate-700">Low 20mm</span>
                                                </button>
                                            </div>
                                        </SectionCard>
                                        ...
                                        <SectionCard title="Trickle Vents">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-slate-600">Add Trickle Vents</span>
                                                <ToggleGroup
                                                    options={[
                                                        { label: 'No', value: 'no' },
                                                        { label: 'Yes', value: 'yes' },
                                                    ...
                                                    onChange={(v) => updateConfig({ trickleVents: v === 'yes' } as any)}
                                                />
                                            </div>
                                        </SectionCard>
                                        ...
                                        <SectionCard title="Hardware Colour">
                                            <HardwareSection config={config as any} onChange={updateConfig as any} />
                                        </SectionCard>
                                    </>
                                )}
                                            ...
                                            <div className="flex justify-center gap-2">
                                                {[3, 4, 5].map(num => (
                                                    <button
                                                        ...
                                                        className={`px-6 py-3 rounded-xl border text-sm font-semibold transition-all min-w-[80px] ${(config as BifoldConfig).panels === num
...
export default function ConfiguratorPage() {
    return (
        <React.Suspense fallback={<div className="flex h-[50vh] items-center justify-center text-slate-400">Loading configurator...</div>}>
            <ConfiguratorContent />
        </React.Suspense>
    );
}
