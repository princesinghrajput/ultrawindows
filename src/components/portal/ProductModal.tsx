...
const products = [
    ...
    { id: "french", name: "Aluminium French Door", image: "/images/french.webp", category: "doors" },
    ...
    { id: "shaped", name: "Aluminium Shaped Frame", image: "/images/shaped.webp", category: "windows" },
    { id: "fixed", name: "Aluminium Fixed Frame", image: "/images/fixed.webp", category: "windows" },
    { id: "bay", name: "Aluminium Bay Window", image: "/images/bay.webp", category: "windows" },
    { id: "rooflight", name: "Aluna+ Rooflight", image: "/images/rooflight_grey.webp", category: "rooflights" },
    { id: "lantern", name: "Roof Lantern", image: "/images/lantern.webp", category: "rooflights" },
];
...
export default function ProductModal({ isOpen, onClose, onSelect }: ProductModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-4xl max-h-[85vh] bg-white rounded-xl overflow-hidden flex flex-col">
                ...
                <div className="flex items-center justify-between p-4 border-b border-slate-200">
                    <div>
                        <h2 className="text-lg font-semibold text-slate-900">Choose a Product</h2>
                        <p className="text-sm text-slate-500">Select a product to start building your quote</p>
                    </div>
