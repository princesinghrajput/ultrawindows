            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    {features.map((feature, index) => (
                        <Reveal key={feature.title} delay={index * 100} width="100%">
                            <div
                                className="bg-white rounded-2xl p-8 text-center border border-slate-100 hover:border-orange-500/20 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group h-full"
                            >
