...
const SidelightModal: React.FC<SidelightModalProps> = ({
  isOpen,
  onClose,
  config,
  onChange,
  ...
  const toggleSidelight = (side: "left" | "right" | "top") => {
    ...
    if (side === "left") {
      newSidelights.left = {
        ...newSidelights.left,
        enabled: !newSidelights.left.enabled,
      };
      // Use default width if enabling
      if (newSidelights.left.enabled && newSidelights.left.width === 0)
        newSidelights.left.width = 400;
    } else if (side === "right") {
      newSidelights.right = {
        ...newSidelights.right,
        enabled: !newSidelights.right.enabled,
      };
      if (newSidelights.right.enabled && newSidelights.right.width === 0)
        newSidelights.right.width = 400;
    } else if (side === "top") {
      newSidelights.top = {
        ...newSidelights.top,
        enabled: !newSidelights.top.enabled,
      };
      if (newSidelights.top.enabled && newSidelights.top.height === 0)
        newSidelights.top.height = 400;
    }
  ...
  const toggleFlag = (side: "left" | "right") => {
    ...
    newSidelights[side] = {
      ...newSidelights[side],
      transom: !newSidelights[side].transom,
    };
    onChange({ sidelights: newSidelights });
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col md:flex-row max-h-[90vh]">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          updateWidth("left", parseInt(e.target.value) || 0)
                        }
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          updateWidth("right", parseInt(e.target.value) || 0)
                        }
                        className="w-full border border-gray-300 rounded px-3 py-2 pr-10 focus:ring-2 focus:ring-orange-200 focus:border-orange-500 outline-none transition-all"
                      />
                      <span className="absolute right-3 top-2 text-gray-400 text-sm">
                ...
                <div className="ml-8 space-y-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      <input
                        type="number"
                        value={config.sidelights.top.height}
                        onChange={(e) => {
                          const newSidelights = { ...config.sidelights };
                          newSidelights.top = {
                            ...newSidelights.top,
        ...
        <div className="w-full md:w-1/2 bg-gray-100 p-8 flex items-center justify-center relative">
          ...
          <div className="w-full h-64 bg-white shadow-lg border-8 border-gray-800 flex flex-col relative">
            {/* Top Light */}
            {config.sidelights.top?.enabled && (
              <div
                className="w-full border-b-4 border-gray-800 bg-blue-50"
                style={{ height: "20%" }}
              />
            )}
            ...
            <div className="flex-1 flex w-full h-full">
              ...
              {config.sidelights.left.enabled && (
                <div
                  className="h-full border-r-4 border-gray-800 bg-blue-50"
                  style={{ width: "20%" }}
                />
              )}
              {/* Center */}
              ...
              {config.sidelights.right.enabled && (
                <div
                  className="h-full border-l-4 border-gray-800 bg-blue-50"
                  style={{ width: "20%" }}
                />
              )}
            </div>
